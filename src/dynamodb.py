...
def hash_user_identity_and_event_name(
    event: dict,
) -> str | None:
...
def check_dynamodb_for_similar_events(
    ...
    response = dynamodb_client.get_item(TableName=cfg.dynamodb_table_name, Key={"principal_structure_and_action_hash": {"S": hash_value}})
